...
public class DifferentElementSteps {
    ...
    //(value = "Open through the header menu Service -> Different Elements Page")
    public DifferentElementSteps openDifferentElementPageTest() {
        homePage.differentElementLink.click();
        return this;
    }

    //(value = "Check interface on Different elements Page, "
    ...
    //(value = "Assert that there is Right Section")
    ...
    //(value = "Assert that for each checkbox there is an individual log row and value"
    ...
    //(value = "Assert that for radiobutton there is a log row"
    ...
    //(value = "Assert that for dropdown there is a log row"
